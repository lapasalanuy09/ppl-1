                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pendaftaran-mahasiswa/{{ $pendaftaran->user->id }}/profile" class="btn btn-primary btn-sm">Info</a>
                                            <a href="/pendaftaran-mahasiswa/{{ $pendaftaran->user->id }}/edit" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="/pendaftaran-mahasiswa/{{ $pendaftaran->user->id }}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Menghapus Data ?')">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
